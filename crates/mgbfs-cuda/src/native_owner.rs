...
mod calls {
    ...
    extern "C" {
        ...
        pub fn mgbfs_bounded_owner_compare_layout(
            plan: *mut c_void,
            jobs: *const BucketJob,
            j: u32,
            rows: u32,
        ...
        pub fn mgbfs_bounded_owner_commit_layout(
            plan: *mut c_void,
            jobs: *const BucketJob,
            j: u32,
            input: *const c_void,
        ...
        pub fn mgbfs_bounded_owner_compare_history_layout(
            plan: *mut c_void,
            jobs: *const BucketJob,
            j: u32,
            rows: u32,
        ...
        pub fn mgbfs_owner_bucket_directory_n(
            sorted: *const c_void,
            count: *const u32,
            capacity: u32,
            buckets: u32,
