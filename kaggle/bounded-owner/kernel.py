"""Focused bounded-owner gate on two independent T4s, NOT a multi-rank BFS."""
import json
import os
...
SOURCE_COMMIT = "0c27d0a491cc733bc6d87d688de8adc396db880c"
