...
## Version 7: settlement at the control barrier

- Pinned source: `278d439a2f2d74fdfe0aeabe8831b1ab06a1d2c4`.
- The two-rank fixture advances an empty source depth 2 while provisional
  target-depth-3 work remains. GPU settlement executes inside its
  `FinalizeDepth` callback, before the rank acknowledges and `Publish` advances
  the control depth. The shorter-history membership outcomes remain unchanged.
- The scatter fixture and standalone future-merge fixture both passed plain
